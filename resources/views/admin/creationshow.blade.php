...
@section('content')
    ...
    <div class="">
        <h1 class="mt-5 w-52 m-auto mb-5 font-bold text-xl ">Les Créations</h1>

        <a class="ml-10 bg-green-700 text-white p-5 rounded-3xl border-2 border-green-700 hover:bg-slate-300 hover:text-green-700" href="{{route('admin.create')}}">Creer une Creation</a>
